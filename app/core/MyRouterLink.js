...
var MyRouterLink = (function () {
    function MyRouterLink(dataServices, compiler, _viewContainerRef) {
    ...
    MyRouterLink.prototype.ngAfterViewInit = function () {
        ...
        this.dataServices.getMenuLinks('?id_usuario=9').subscribe(function (res) {
    ...
    MyRouterLink = __decorate([
        ...
        __metadata('design:paramtypes', [menu_service_1.MenuServices, core_1.Compiler, core_1.ViewContainerRef])
    ], MyRouterLink);
    return MyRouterLink;
}());
